...
class AzureTenantTable(NetBoxTable):
    ...
    tenid = tables.Column(linkify=True, verbose_name="Tenant ID")
    name = tables.Column(linkify=True, verbose_name="Tenant Name")
...
class AzureSubscriptionTable(NetBoxTable):
    ...
    subid = tables.Column(linkify=True, verbose_name="Subscription ID")
    name = tables.Column(linkify=True, verbose_name="Subscription Name")
    comment = tables.Column(verbose_name="Comment")
    status = ChoiceFieldColumn(verbose_name="Status")
    approver = tables.Column(verbose_name="Approver")
    ...
    class Meta(NetBoxTable.Meta):
        ...
        default_columns = ("subid", "name", "approver", "owner", "status", "comment")
