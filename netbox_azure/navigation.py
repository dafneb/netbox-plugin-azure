    ...
    groups=(
        ('Azure Inventory', (
            PluginMenuItem(
                ...
                link_text='Tenants',
                buttons=(
                    PluginMenuButton('plugins:netbox_azure:azuretenantmodel_add', 'Add', 'mdi mdi-plus-thick'),
            ...
            PluginMenuItem(
                ...
                buttons=(
                    PluginMenuButton('plugins:netbox_azure:azuresubscriptionmodel_add', 'Add', 'mdi mdi-plus-thick'),
                    # PluginMenuButton('plugins:netbox_branching:branch_bulk_import', 'Import', 'mdi mdi-upload'),
                )
            ),
        )),
